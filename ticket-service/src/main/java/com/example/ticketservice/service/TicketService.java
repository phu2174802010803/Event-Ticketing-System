...
public class TicketService {
    ...
    private void sendTicketConfirmationEmail(List<Ticket> tickets, String transactionId, String eventName,
        ...
        try {
            ...
            List<SendGridEmailService.TicketEmailInfo> ticketInfos = tickets.stream()
                    .map(ticket -> new SendGridEmailService.TicketEmailInfo(
            ...
            // Gửi email
            sendGridEmailService.sendTicketConfirmationEmail( // ← Thay đổi
                    user.getEmail(),
                    user.getFullName(),
                    eventDetail.getName(),
