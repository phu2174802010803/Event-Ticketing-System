...
public class QueueService {
    ...
    private static final int MAX_ACTIVE_USERS = 1000; // Giới hạn 1000 người dùng đồng thời
    private static final int MAX_QUEUE_SIZE = 1000;   // Hàng đợi 1000 người
    private static final int ACCESS_TIME_MINUTES = 10; // TTL cho người dùng hoạt động
